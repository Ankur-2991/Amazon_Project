...
public class Search_TC94_ShopCart_Remove_All {
	...
	public static void main(String[] args) {
		...
		if(check.size()!=0) {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				driver.findElement(By.xpath("//*[@id=\"sc-active-C439e0e90-6e1a-4d04-94ce-f88018f66f7d\"]/div[4]/div/div[3]/div[1]/span[2]")).click();
				String finalPrice=driver.findElement(By.xpath("//*[@id=\"sc-subtotal-amount-activecart\"]/span")).getText();
				if(finalPrice=="0") {
