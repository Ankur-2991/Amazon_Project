...
public class Search_TC96_ShopCart_Session {
	...
	public static void main(String[] args) {
		...
		if(check.size()!=0) {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				String title=driver.findElement(By.xpath("//*[@id=\"sc-active-C6f6c7888-3bbf-46a0-a144-c8e6edc28943\"]/div[4]/div/div[3]/ul/li[1]/span/a/span[1]/span/span[2]")).getText();
				driver.close();
				driver.get("https://www.amazon.com/");
				driver.findElement(By.id("nav-cart")).click();
				String titleAgain=driver.findElement(By.xpath("//*[@id=\"sc-active-C6f6c7888-3bbf-46a0-a144-c8e6edc28943\"]/div[4]/div/div[3]/ul/li[1]/span/a/span[1]/span/span[2]")).getText();
				if(title==titleAgain) {
