...
public class Your_Add_TC36_Phn_Empty {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				if(FinalCheck.size()!=0) {
					...
					if(reFinalCheck==order) {
						...
						String error=driver.findElement(By.xpath("//*[@id=\"address-ui-widgets-enterAddressFormContainer\"]/div[7]/div/div[6]/div/div[1]/div/div/div")).getText();
						if(error=="Please enter a phone number so we can call if there are any issues with delivery.") {
