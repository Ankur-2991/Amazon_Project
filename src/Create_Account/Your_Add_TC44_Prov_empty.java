...
public class Your_Add_TC44_Prov_empty {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				if(FinalCheck.size()!=0) {
					...
					if(reFinalCheck==order) {
						...
						String error=driver.findElement(By.xpath("//*[@id=\"address-ui-widgets-enterAddressFormContainer\"]/div[7]/div/div[14]/div/div[1]/div/div/div")).getText();
						if(error=="Please enter a state, region, or province.") {
