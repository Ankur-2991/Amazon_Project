...
public class Your_Add_TC35_NameField {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				if(FinalCheck.size()!=0) {
					...
					if(reFinalCheck==order) {
						...
						String nameField=driver.findElement(By.id("address-ui-widgets-enterAddressFullName")).getText();
						if(nameField.isEmpty()) {
							...
							if(nameField=="Ankur Bansal") {driver.close();}
							else {
