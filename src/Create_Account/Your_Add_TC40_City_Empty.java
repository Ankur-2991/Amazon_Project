...
public class Your_Add_TC40_City_Empty {
			...
			if(reCheck.size()!=0 && reCheckTwo.size()!=0) {
				...
				if(FinalCheck.size()!=0) {
					...
					if(reFinalCheck==order) {
						...
						String error=driver.findElement(By.xpath("//*[@id=\"address-ui-widgets-enterAddressFormContainer\"]/div[7]/div/div[11]/div[1]/div[2]/div/div[1]/div/div/div")).getText();
						if(error=="Please enter a city name.") {
